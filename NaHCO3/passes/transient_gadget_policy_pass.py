...
class TransientGadgetPolicyPass(InstVisitorPassMixin):
    ...
    def visit_inst(self, inst: CsInsn, inst_idx: int, inst_offset: int,
        ...
        if inst.mnemonic in ("lea", "nop", "ret", "push", "call") or inst.mnemonic.startswith("j"):
            return
